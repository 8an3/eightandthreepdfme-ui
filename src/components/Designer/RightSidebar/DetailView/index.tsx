    ...
    properties: {
      ...
      name: {
        ...
        props: { options: [
          ...
          {label: 'Client', value:'clientAtr'},
          {label: 'Vehicle Info', value:'wantedVehAttr'},
          {label: 'tradeInfo', value:'tradeInfo'},
          {label: 'Trade Info', value:'tradeInfo'},
          {label: 'Unit Info from Inventory', value:'unitInfo'},
          {label: 'Sales Person', value:'salesPersonAttr'},
          {label: 'FandIAttr', value:'Finance Manager'},
          {label: 'Dealer Charges', value:'dealerCharges'},
          {label: 'Dealer Info', value:'dealerInfo'},
          {label: 'Sales Deal Info', value:'financeInfo'},
        ] },
        required: true,
        span: 12,
        rules: [{
